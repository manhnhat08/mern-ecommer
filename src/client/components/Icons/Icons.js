export const UplloadIcon = ({ className, width = '2.0rem', height = '2.0rem' }) => (
    <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fas"
...
export const PenIcon = ({ className, width = '1.4rem', height = '1.6rem' }) => (
    <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fas"
...
export const HomeIcon = ({ className, width = '2.0rem', height = '2.0rem' }) => (
    <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fas"
...
export const RoadIcon = ({ className, width = '2.0rem', height = '2.0rem' }) => (
    <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fas"
...
export const LightbulbIcon = ({ className, width = '2.0rem', height = '2.0rem' }) => (
    <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fas"
...
export const NewspaperIcon = ({ className, width = '2.0rem', height = '2.0rem' }) => (
    <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fas"
